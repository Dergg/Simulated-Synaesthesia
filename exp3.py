...
# Leaving out minor for memory efficiency

n_fft = 2048 * 4 # This was in the previous code and I can't remember what it does, but it must be there for a reason
...
def update(frame):
    ...
    if rms_norm[int((time_pos * sr) // 512)] > 0.8:
        for _ in range(10):
            ...
            particles.add(Particle(x, y, (0.5, 0.5, 1.0), size, speed))  # Soft blue burst
